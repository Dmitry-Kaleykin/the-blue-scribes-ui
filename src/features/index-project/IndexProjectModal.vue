...
const canSubmit = computed(() =>
  form.root.trim().length > 0 && form.profile.length > 0 && !submitting.value,
)
    ...
    <form class="form-stack" @submit.prevent="submit">
      <label class="field">
        ...
        <div class="input-with-icon">
          ...
          <input v-model="form.root" required placeholder="/Users/you/Projects/application">
        </div>
      ...
      <div class="form-grid form-grid--two">
        ...
        <label class="field">
          ...
          <input v-model="form.target" placeholder="release128">
      ...
      <div class="form-grid form-grid--three">
        <label class="field">
          ...
          <input v-model.number="form.maximumChunkSize" min="1" required type="number">
        </label>
        <label class="field">
          <span>Older builds to keep</span>
          <input v-model.number="form.keepReplacedBuilds" min="0" required type="number">
        </label>
        <label class="check-field check-field--compact">
          <input v-model="form.windows1251" type="checkbox">
          <span>
      ...
      <div v-if="advanced" class="form-section">
        <label class="check-field">
          <input v-model="form.allowDirty" type="checkbox">
          <span>
        ...
        <div class="form-grid form-grid--two">
          <label class="field">
            ...
            <textarea v-model="form.include" rows="4" placeholder="src/**&#10;design/**" />
            <small>One glob per line.</small>
          </label>
          <label class="field">
            <span>Exclude patterns</span>
            <textarea v-model="form.exclude" rows="4" placeholder="vendor/**&#10;dist/**" />
            <small>Applied in addition to normal ignore policy.</small>
          </label>
        </div>
      </div>

      <p v-if="profiles.length === 0" class="feedback feedback--warning">
